...
import 'package:flutter_web_app/weather-card.dart';
import 'package:flutter_web_app/weather-data.dart';
...
class _HomeState extends State<Home> {
  ...
  WeatherData _weatherData = WeatherData('torontoon');
  String? _apiError;
  ...
  fetchWeatherData({required String location}) async {
    ...
    var path='/api/weather/$location';
    print(WEATHER_API_URL+path);
    //var url = Uri.http(WEATHER_API_URL,path);
    //print(url);
    final response = await http.get(Uri.parse(WEATHER_API_URL+path));
